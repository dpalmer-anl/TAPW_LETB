...
def cont_potential(n_moire: int, n_g: int, valley: int = 1,i: int = 0):
    ...
    ham_dim1 = int(hamk.shape[0]/2)
    ham_dim2 = 2*ham_dim1
    u = hamk_shuffled[0:ham_dim1, ham_dim1:ham_dim2]
    ...
    return {'u1': u1, 'u2': u2, 'u3': u3, 'u4': u4,'glist':o_g_vec_list}
